    ...
    <>
      ...
      >
        <form onSubmit={(e) => handleSubmit(e)}>
          <ModalOverlay />
          <ModalContent>
            <ModalHeader p="0.6rem 1.4rem 0rem 1.4rem">
              <Flex align="center">
                <Text
            ...
            <ModalBody>
              <VStack fontSize="0.8rem">
                <Flex w="100%" align="flex-start" direction="column">
                  <Alert status="warning" fontSize="0.7rem" mb="1rem">
                    <AlertIcon />
                    As a guest user, feel free to customize your profile.
                    However, any changes will be discarded after you close the
                    browser tab.
                  </Alert>
...
export default EditProfile_Guest;
